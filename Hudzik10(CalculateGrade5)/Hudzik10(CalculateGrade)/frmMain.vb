Public Class frmMain 'Algorithm Step 1
    ...
    Private Sub btnCalculate_Click(sender As Object, e As EventArgs) Handles btnCalculate.Click, mnuCalculate.Click 'Can also be activated using enter
        ...
        Static dblGradesEntered As Double
...
SOME THING DID A WRONG", "OOF", MessageBoxButtons.YesNo, MessageBoxIcon.Question) 'Error message
        ...
        dblGradesEntered += 1
        lblGradesEntered.Text = dblGradesEntered
